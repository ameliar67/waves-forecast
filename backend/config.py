...
class Config:
    def __init__(self, is_development: bool, s3_bucket: Bucket):
    ...
    def from_environment():
        ...
        Config.validate(s3_service_url, s3_bucket_name, s3_access_key_id, s3_secret_key)
        ...
        return Config(is_development, s3_bucket)
